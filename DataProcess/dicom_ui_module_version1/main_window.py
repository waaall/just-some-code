...
class MainWindow(QMainWindow):
    ...
    def bind_dock_options(self):
        ...
        # self.dock_window.modelBut.clicked.connect(self.openSModelWindow)
        # self.dock_window.fricCreatBut.clicked.connect(self.openBeforeFricWindow)
        # self.dock_window.tepCreatBut.clicked.connect(self.openBeforeTepWindow)
        # self.dock_window.fricPlotBut.clicked.connect(self.openPlotFricWindow)
        # self.dock_window.tepPlotBut.clicked.connect(self.openPlotTepWindow)
        # self.dock_window.fileButF.clicked.connect(self.openFileFWindow)
