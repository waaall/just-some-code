...
def main():
    ...
    window.FileWindow.selected_signal.connect(merge_colors_bind.get_user_select)      
    ...
    window.FileWindow.selected_signal.connect(dicom_bind.get_user_select)   
    ...
    window.FileWindow.selected_signal.connect(split_color_bind.get_user_select)   
